 ...
 header start-->
        <nav class="admin-header navbar navbar-default col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
            ...
            <ul class="nav navbar-nav ml-auto">
                <div class="dropdown d-inline-block user-dropdown" style="padding-top: 5px">
                    <button type="button" class="btn header-item waves-effect" id="" data-bs-toggle="dropdown"
                        aria-haspopup="true" aria-expanded="false">
                        <span class="d-none d-xl-inline-block ms-1">language</span>
